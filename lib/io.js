...
var IO = exports.IO =
{
  ...
  {
    _fileSystem.readOpt(file.path, function(result)
    {
      if (result.error)
        callback(result.error);
      else
      {
        var lines = result.content_ascii;
  ...
  readFromFileOld: function(file, listener, callback, timeLineID)
  {
